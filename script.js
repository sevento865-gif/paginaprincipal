...
function mostrarProductos(lista) {
  ...
  if (lista.length === 0) {
    contenedor.innerHTML =
      `<p style="color:#aaa;text-align:center;padding:40px;grid-column:1/-1">
  ...
  lista.forEach(producto => {
    ...
    const etiqueta     = etiquetas[producto.categoria] || producto.categoria || "";
      ...
      <div class="producto">
        ...
        <div class="info">
          ...
          <div class="producto-btns">
            <button
              class="btn-whatsapp"
              onclick="enviarWhatsApp('${nombreSeguro}')">
